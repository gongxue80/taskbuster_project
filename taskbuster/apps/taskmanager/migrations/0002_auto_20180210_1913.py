# Generated by Django 2.0.2 on 2018-02-10 11:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#fff', help_text='Enter the hex color code, like #ccc or # cccccc', max_length=7, validators=[django.core.validators.RegexValidator('(^#[0-9a-fA-F]{3}$)|(^#[9-9a-fA-F]{6}$)')], verbose_name='color')),
            ],
            options={
